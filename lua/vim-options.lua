...
vim.keymap.set("n", "<C-3>", ":ToggleTerm 3<CR>")
vim.keymap.set("n", "<C-4>", ":ToggleTerm 4<CR>")
vim.keymap.set("n", "<C-5>", ":ToggleTerm 5<CR>")
vim.keymap.set("n", "<C-6>", ":ToggleTerm 6<CR>")
vim.keymap.set("n", "<C-7>", ":ToggleTerm 7<CR>")
vim.keymap.set("n", "<C-8>", ":ToggleTerm 8<CR>")
vim.keymap.set("n", "<C-9>", ":ToggleTerm 9<CR>")
vim.keymap.set("n", "<C-0>", ":ToggleTerm 10<CR>")
